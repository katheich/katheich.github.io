  ...
  return (<section className="section" id="about">
    <div className="container">
      ...
      <div className="text">
        ...
        <br/><br/>
        Proin porta odio vitae ligula efficitur elementum. Sed hendrerit aliquam diam, in volutpat turpis gravida non. Integer est ligula, pretium id malesuada quis, faucibus eu erat. Pellentesque eu vehicula leo, sit amet finibus libero. Quisque at laoreet lorem, in ultricies enim. Fusce consectetur, elit vel commodo scelerisque, est lorem ultrices lorem, vitae scelerisque magna mi non nulla. Duis euismod vitae felis at sollicitudin. Nam finibus lectus eget ex tempor, vitae vehicula est interdum.
      </div>
    </div>
  </section>)
